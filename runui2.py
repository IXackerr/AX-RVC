		...
		with gr.Tabs():
			...
			with gr.TabItem('HuggingFace 🤗'):
				with gr.Row():
					...
					with gr.Column():model_name_gr=gr.Textbox(label='Trained model name:');zip_name_gr=gr.Textbox(label='Name of Zip file:');what_upload_gr=gr.Radio(label='Upload files:',choices=[_t,_A2],value=_t,interactive=_A,visible=_A)
