...
with gr.Blocks(title='RVC WebUI')as app:
	...
	if config.iscolab or config.paperspace:app.queue(max_threads=511,max_size=1022).launch(server_name='0.0.0.0',inbrowser=not config.noautoopen,server_port=config.listen_port,quiet=_A,share=_B)
	else:app.queue(max_threads=511,max_size=1022).launch(server_name='0.0.0.0',inbrowser=not config.noautoopen,server_port=config.listen_port,quiet=_A)