	...
	with gr.Tabs():
		with gr.TabItem(i18n('模型推理')):
			...
			with gr.TabItem(i18n('单次推理')):
				with gr.Group():
					with gr.Row():
						with gr.Column():dropbox=gr.File(label=i18n('Drag your audio here:'),show_progress=_A);record_button=gr.Audio(sources='microphone',label=i18n('Or record an audio:'),type='filepath')
