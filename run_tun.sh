...
# Check if "tunnels:" already exists and insert it if not
...
insert_line_num=$(grep -n "^tunnels:" "$NGROK_CONFIG_FILE" | cut -d: -f1)
# Increment the line number to insert after the "tunnels:" line
